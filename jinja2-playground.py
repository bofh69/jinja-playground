...
''')
        ...
        self._output_text = scrolledtext.ScrolledText(frame, wrap=tk.WORD, width=40, height=10, state='disabled')
        self._output_text.grid(row=1, column=2, padx=5, pady=5, sticky="nsew")

        self._console_text = scrolledtext.ScrolledText(self._root, wrap=tk.WORD, height=5, state='disabled')
